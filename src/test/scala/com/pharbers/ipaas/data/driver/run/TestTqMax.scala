...
//
//	test("clean tq RP panel") {
//		val phJobs = inst(readJobConfig("max_config/tq/RPcleanPanel.yaml"))
...
//		val panelDF = sd.setUtil(readCsv()).readCsv("hdfs:///data/TQ/RP_Panel 201806.csv")
//
//		panelERD.show(false)
//		panelDF.show(false)
//
...
//
////		sd.setUtil(save2Parquet()).save2Parquet(panelERD, "hdfs:///workData/Panel/tq/rp/201806")
//	}
//
//	test("clean tq RP universe") {
//		val phJobs = inst(readJobConfig("max_config/tq/RPcleanUniverse.yaml"))
//		val result = phJobs.head.perform(PhMapArgs(Map(
//			"sparkDriver" -> PhSparkDriverArgs(sd),
//			"logDriver" -> PhLogDriverArgs(PhLogDriver(formatMsg("test_user", "test_traceID", "test_jobID")))
//		)))
...
//	}
//
//	test("clean tp SA panel") {
//		val phJobs = inst(readJobConfig("max_config/tq/SAcleanPanel.yaml"))
//		val result = phJobs.head.perform(PhMapArgs(Map(
//			"sparkDriver" -> PhSparkDriverArgs(sd),
//			"logDriver" -> PhLogDriverArgs(PhLogDriver(formatMsg("test_user", "test_traceID", "test_jobID")))
//		)))
//
//		val panelERD = result.toMapArgs[PhDFArgs].get("panelERD").get
//		val panelDF = sd.setUtil(readCsv()).readCsv("hdfs:///data/TQ/SA_Panel 201806.csv")
//
//		panelERD.show(false)
//		panelDF.show(false)
//
...
//		assert(Math.abs(panelERDSales - panelDFSales) < (panelDFSales * 0.01))
//
////		sd.setUtil(save2Parquet()).save2Parquet(panelERD, "hdfs:///workData/Panel/tq/sa/201806")
//	}
//
//	test("clean tq SA universe") {
//		val phJobs = inst(readJobConfig("max_config/tq/SAcleanUniverse.yaml"))
//		val result = phJobs.head.perform(PhMapArgs(Map(
//			"sparkDriver" -> PhSparkDriverArgs(sd),
//			"logDriver" -> PhLogDriverArgs(PhLogDriver(formatMsg("test_user", "test_traceID", "test_jobID")))
//		)))
