...
import com.pharbers.ipaas.data.driver.api.work.{PhOperatorTrait, PhStringArgs, PhWorkArgs}

/**
  *
  * @param args PhMapArgs
  * @tparam T PhMapArgs(map(valueColumnName -> 要计算的列名，dateColName -> 日期的列名，partitionColumnNames -> 用来分组的一列或多列的列名))
  */
